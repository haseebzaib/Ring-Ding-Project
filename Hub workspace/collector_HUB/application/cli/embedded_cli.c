...
CLI_UINT CLI_BUFFER[CLI_BUFFER_SIZE];
/**
...
EmbeddedCliConfig *embeddedCliDefaultConfig(void) {
    ...
    defaultConfig.historyBufferSize = 0;
    defaultConfig.cliBuffer = NULL;//CLI_BUFFER;
    defaultConfig.cliBufferSize = 128;//CLI_BUFFER_SIZE;
    defaultConfig.maxBindingCount = 64;
