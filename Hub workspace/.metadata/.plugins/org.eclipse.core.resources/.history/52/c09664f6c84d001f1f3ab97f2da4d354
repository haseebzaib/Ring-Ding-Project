...
static char flashBuf1[0x8000] __attribute__ ((retain, noinit, location(0xe1000)));

#elif defined(__IAR_SYSTEMS_ICC__)

__no_init static char flashBuf0[0x8000] @ 0x4e000;
__no_init static char flashBuf1[0x8000] @ 0xe1000;
...
const uint_least8_t CONFIG_NVS_CUSTOM_CONST = CONFIG_NVS_CUSTOM;
